...
export enum ChannelID {
    UCyZgGJiy9Vum1XD7HXWGRA = "UCyZgGJiy9vum1xD7hXWG_rA",
}

export enum ChannelTitle {
    MoratTopic = "Morat - Topic",
}

export enum PlaylistID {
    PLkY2XkgAay7L9KXvXlsYf9UWKEABR1L = "PLkY_2xkgAay7L9KXvXlsYf9uWKEAB_R1l",
}
...
export class Convert {
    public static toYoutube(json: string): Youtube {
        return cast(JSON.parse(json), r("Youtube"));
    }

    public static youtubeToJson(value: Youtube): string {
        return JSON.stringify(uncast(value, r("Youtube")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "ChannelID": [
        "UCyZgGJiy9vum1xD7hXWG_rA",
    ],
    "ChannelTitle": [
        "Morat - Topic",
    ],
    "PlaylistID": [
        "PLkY_2xkgAay7L9KXvXlsYf9uWKEAB_R1l",
    ],
    "ResourceIDKind": [
        "youtube#video",
    ],
